        ...
        <ul className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {bookings.map((booking, index) => (
            ...
            >
              ...
              <p className="text-gray-800 text-3xl"><strong>Contact:</strong> {booking.contact}</p>
              <p className="text-gray-800 text-3xl"><strong>Date:</strong> {booking.date}</p>
              <p className="text-gray-800 text-3xl"><strong>Location:</strong> {booking.location}</p>
              <p className="text-gray-800 text-3xl"><strong>Preferences:</strong> {booking.preferences}</p>
